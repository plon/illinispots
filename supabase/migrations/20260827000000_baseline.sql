...
REVOKE ALL ON SEQUENCE "public"."academic_terms_id_seq" FROM "anon";
REVOKE ALL ON SEQUENCE "public"."academic_terms_id_seq" FROM "authenticated";
GRANT ALL ON SEQUENCE "public"."academic_terms_id_seq" TO "service_role";



REVOKE ALL ON TABLE "public"."buildings" FROM "anon";
REVOKE ALL ON TABLE "public"."buildings" FROM "authenticated";
...
REVOKE ALL ON TABLE "public"."class_schedule" FROM "authenticated";
...
REVOKE ALL ON SEQUENCE "public"."class_schedule_id_seq" FROM "anon";
REVOKE ALL ON SEQUENCE "public"."class_schedule_id_seq" FROM "authenticated";
GRANT ALL ON SEQUENCE "public"."class_schedule_id_seq" TO "service_role";



REVOKE ALL ON TABLE "public"."daily_events" FROM "anon";
REVOKE ALL ON TABLE "public"."daily_events" FROM "authenticated";
...
REVOKE ALL ON SEQUENCE "public"."daily_events_id_seq" FROM "anon";
REVOKE ALL ON SEQUENCE "public"."daily_events_id_seq" FROM "authenticated";
GRANT ALL ON SEQUENCE "public"."daily_events_id_seq" TO "service_role";



REVOKE ALL ON TABLE "public"."room_availability_cache" FROM "anon";
REVOKE ALL ON TABLE "public"."room_availability_cache" FROM "authenticated";
...
-- A public-schema dump omits the role timeouts used by API and maintenance calls.
ALTER ROLE "anon" SET "statement_timeout" TO '6s';
ALTER ROLE "authenticated" SET "statement_timeout" TO '8s';
ALTER ROLE "authenticator" SET "statement_timeout" TO '8s';
ALTER ROLE "service_role" SET "statement_timeout" TO '60s';
